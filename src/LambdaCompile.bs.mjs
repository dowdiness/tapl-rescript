...
console.log("ANF:", printANF(testSimpleTuple));

console.log("LLVM IR:", lowerPhase3(testSimpleTuple));

var testTupleWithVars = {
  TAG: "Bop",
  _0: "a",
  _1: "Plus",
  _2: {
...
console.log("ANF:", printANF(testTupleWithVars));

console.log("LLVM IR:", lowerPhase3(testTupleWithVars));

var testMultipleProj = {
  TAG: "Tuple",
  _0: "t",
  _1: {
    hd: {
...
console.log("ANF:", printANF(testMultipleProj));

console.log("LLVM IR:", lowerPhase3(testMultipleProj));
